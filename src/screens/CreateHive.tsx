...
export const CreateHiveScreen: React.FunctionComponent<Props> = ({
  navigation,
}) => {
  ...
  const onCreateHive = (password: string) =>
    withLoading(async () => {
      try {
        ...
        console.log('onCreateHive#error', (error as Error).message);
      }
    });
